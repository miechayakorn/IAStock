                                ...
                                <tbody>
                                    <c:forEach items="${items}" varStatus="vs" var="item">
                                        <tr class="d-flex">        
                                            ...
                                            <td class="col-5">
                                                <form action="Stock_draw">
                                                    <div class="form-row">
                                                        <div class="col-5 mt-1">
                                                            <input type="number" name="draw" min="0" class="form-control" required placeholder="จำนวนที่เบิก">
...
<script>
    ${message == "error" ? 'swal({title: "Invalid!!",text: " Error",icon: "warning",dangerMode: true,});' : ""}
</script>
</body>
